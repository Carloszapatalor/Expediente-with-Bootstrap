        ...
        <div class="card-body">
         ...
         <div class="row gx-3">
             ...
             <div class="col-md-6">
                 ...
                 <div class="mb-3">
                     <label class="small mb-1" for="lastname">Apellidos</label>
                     <input class="form-control" id="lastname" type="text" value="{{ Auth::user()->lastname }}"
                         required>
                 </div>
             </div>
             <div class="col-md-6">
         ...
         <div class="card-body">
             <div class="row no-gutters align-items-center">
                 <div class="col mr-2">
                     <div class="text-xl text-center font-weight-bold text-success text-uppercase mb-1">
         ...
         <!-- Form Group (submit)-->
         <a class="btn btn-primary btn-block" type="submit">Agendar Cita</a>
